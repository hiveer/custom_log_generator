...
Gem::Specification.new do |spec|
  spec.name          = "custom_log_generator"
  spec.version       = CustomLogGenerator::VERSION
  spec.authors       = ["Hiveer Li"]
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "https://github.com/hiveer/custom_log_generator"
    spec.metadata["changelog_uri"] = "https://github.com/hiveer/custom_log_generator"
  else
